            ...
            Papa.parse(csvData, {
                ...
                complete: function (result) {
                    ...
                    function getCategoryBasedOnTime() {
                        ...
                        else if (currentHour < 18) return "Sandwiches";
                        else return "Broasted Chicken";
                    }

                    // Check for URL parameter to set the category filter
                    const urlParams = new URLSearchParams(window.location.search);
                    let urlCategory = urlParams.get('category');

                    if (urlCategory && sortedCategories.includes(urlCategory)) {
                        selectedCategorySpan.textContent = urlCategory;
